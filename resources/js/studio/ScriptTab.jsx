...
const COMPLETIONS = [
    ...
    prop('plugin.ui', 'list of controls: number, checkbox, color, text, button, image'),
    ...
    prop('plugin.brush', 'true to paint with the left mouse button; needs a "radius" control'),
    fn('plugin.paint(part, values)', 'brush handler; return only the fields to change, e.g. { C = "ff0000" }'),
    prop('part.D', 'how far into the brush this part is, 0 at the centre to 1 at the edge'),
    prop('Brush', 'the brush being dragged, or nil: Brush.center {x,y,z}, Brush.radius'),
    fn('json.decode(s)', 'parse a JSON string into a table'),
    prop('Selection', 'the whole selection, or nil: count, min, max, center, parts'),
    prop('Selection.center', 'centre of the selection bounds {x, y, z}'),
