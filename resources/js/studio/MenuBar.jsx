...
export default function MenuBar({
    ...
    const MENUS = [
        ...
        ['View', [
            { label: 'Hide selection', shortcut: 'H', onClick: onHide, disabled: !hasSelection },
            { label: `Show all${hiddenCount ? ` (${hiddenCount})` : ''}`, shortcut: 'Shift+H', onClick: onShowAll, disabled: !hiddenCount },
            { label: 'Lock selection', shortcut: 'L', onClick: onLock, disabled: !hasSelection },
            { label: `Unlock all${lockedCount ? ` (${lockedCount})` : ''}`, shortcut: 'Shift+L', onClick: onUnlockAll, disabled: !lockedCount },
            SEP,
